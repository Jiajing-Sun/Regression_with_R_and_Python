...
workbooks <- c(
  ...
  "Chapter11_Nonparametric_Regression_chapter_nonparametric/chapter11_workbook.Rmd",
  "Chapter12_Time_series_analysis/chapter12_workbook.Rmd",
  "Chapter13_Causal_analyses_ch_causality/chapter13_workbook.Rmd"
)
