...
- Runnable companion script: [R/chapter09.R](R/chapter09.R)
- Reference workbook: [chapter09_workbook.Rmd](chapter09_workbook.Rmd)
...
```{r runnable-logistic-regression-in-r-01}
...
```{r runnable-logistic-regression-in-r-02}
...
```{r runnable-logistic-regression-in-r-03}
...
```{r runnable-logistic-regression-in-r-04}
...
```{r runnable-logistic-regression-in-r-05}
 summary(logit_model)
```
...
```{r runnable-logistic-regression-in-r-06}
    df$lnpop <- log(df$pop)
...
```{r runnable-logistic-regression-in-r-07}
...
```{r runnable-logistic-regression-in-r-08}
 exp(beta1hat * .01)
```
...
```{r runnable-example-in-r-with-the-probability-of-heart-disease-09}
...
```{r runnable-example-in-r-with-the-probability-of-heart-disease-10}
...
```{r runnable-example-in-r-with-the-probability-of-heart-disease-11}
...
```{r runnable-example-in-r-with-the-probability-of-heart-disease-12}
...
```{r runnable-example-in-r-with-the-probability-of-heart-disease-13}
...
```{r runnable-example-in-r-with-the-probability-of-heart-disease-14}
...
```{r runnable-example-in-r-with-the-probability-of-heart-disease-15}
...
```{r runnable-example-in-r-with-the-probability-of-heart-disease-16}
...
```{r runnable-example-in-r-with-the-probability-of-heart-disease-17}
...
```{r runnable-example-in-r-with-the-probability-of-heart-disease-18}
...
```{r runnable-example-in-r-with-the-probability-of-heart-disease-19}
...
```{r runnable-example-in-r-with-the-probability-of-heart-disease-20}
    df_female <- df
    df_female$male <- 0
    df_male <- df
    df_male$male <- 1
