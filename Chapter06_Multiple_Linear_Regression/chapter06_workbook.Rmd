...
```{r confidence-intervals-for-expected-value-and-prediction-intervals-in-r-24}
...
```{r confidence-intervals-for-expected-value-and-prediction-intervals-in-r-25}
