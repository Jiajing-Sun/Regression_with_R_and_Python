...
```{r runnable-robust-f-test-in-r-16}
    library("lmtest")
    library("sandwich")
```
...
```{r runnable-robust-f-test-in-r-17}
...
```{r runnable-confidence-intervals-for-expected-value-and-prediction-intervals-in-r-18}
...
```{r runnable-confidence-intervals-for-expected-value-and-prediction-intervals-in-r-19}
  n <- nobs(ols_model)
