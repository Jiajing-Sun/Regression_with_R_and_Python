...
- Runnable companion script: [R/chapter08.R](R/chapter08.R)
- Reference workbook: [chapter08_workbook.Rmd](chapter08_workbook.Rmd)
...
```{r runnable-project-star-and-clustering-in-r-01}
# Load data
...
```{r runnable-project-star-and-multilevel-models-in-r-02}
# install.packages(c("lme4"))  # install manually if needed
```
...
```{r runnable-project-star-and-multilevel-models-in-r-03}
df <- read.csv("star.csv")
...
```{r runnable-the-within-estimator-with-municipal-data-in-r-04}
