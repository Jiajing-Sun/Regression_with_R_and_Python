...
```{r example-with-training-and-test-data-02}
    for (i in 2:10) {
...
```{r example-with-training-and-test-data-03}
    set.seed(12)
    n <- nrow(df)
    train_share <- .8
...
```{r example-with-training-and-test-data-04}
...
```{r example-with-training-and-test-data-05}
    f <- "price ~ living_area"
...
```{r comparison-of-the-different-prediction-models-25}
...
```{r comparison-of-the-different-prediction-models-26}
...
```{r comparison-of-the-different-prediction-models-27}
...
```{r comparison-of-the-different-prediction-models-28}
...
```{r comparison-of-the-different-prediction-models-29}
...
```{r comparison-of-the-different-prediction-models-30}
...
```{r comparison-of-the-different-prediction-models-31}
...
```{r comparison-of-the-different-prediction-models-32}
...
```{r comparison-of-the-different-prediction-models-33}
...
```{r comparison-of-the-different-prediction-models-34}
...
```{r comparison-of-the-different-prediction-models-35}
...
```{r comparison-of-the-different-prediction-models-36}
 set.seed(12)
 n <- nrow(df)
...
```{r comparison-of-the-different-prediction-models-37}
...
```{r comparison-of-the-different-prediction-models-38}
...
```{r comparison-of-the-different-prediction-models-39}
