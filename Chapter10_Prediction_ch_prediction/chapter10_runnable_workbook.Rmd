...
```{r runnable-ridge-and-lasso-in-r-02}
...
```{r runnable-ridge-and-lasso-in-r-03}
  df <- read.csv("apartment_price_data.csv")
  df <- df[complete.cases(df), ]
```
...
```{r runnable-ridge-and-lasso-in-r-04}
...
```{r runnable-ridge-and-lasso-in-r-05}
 X <- makeX(dfX)
 Y <- df$price
...
```{r runnable-ridge-and-lasso-in-r-06}
...
```{r runnable-regression-tree-in-r-08}
...
```{r runnable-regression-tree-in-r-09}
 df <- read.csv("apartment_price_data.csv")
```
...
```{r runnable-regression-tree-in-r-10}
...
```{r runnable-regression-tree-in-r-11}
...
```{r runnable-regression-tree-in-r-12}
...
```{r runnable-regression-tree-in-r-13}
 printcp(tree_model)
```
...
```{r runnable-comparison-of-the-different-prediction-models-14}
 df <- read.csv("apartment_price_data.csv")
...
```{r runnable-comparison-of-the-different-prediction-models-15}
...
```{r runnable-comparison-of-the-different-prediction-models-16}
...
```{r runnable-comparison-of-the-different-prediction-models-17}
...
```{r runnable-comparison-of-the-different-prediction-models-18}
...
```{r runnable-comparison-of-the-different-prediction-models-19}
...
```{r runnable-comparison-of-the-different-prediction-models-20}
...
```{r runnable-comparison-of-the-different-prediction-models-21}
 set.seed(12)
 n <- nrow(df)
...
```{r runnable-comparison-of-the-different-prediction-models-22}
...
```{r runnable-comparison-of-the-different-prediction-models-23}
