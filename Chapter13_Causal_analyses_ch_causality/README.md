...
- `chapter13_workbook.Rmd` is the reference workbook that shows chapter code in textbook order.
- `chapter13_runnable_workbook.Rmd` is the runnable workbook with setup code added so the chapter can usually be executed end-to-end.
...
- [`R/boxes/box01_rd_approach_in_r.R`](R/boxes/box01_rd_approach_in_r.R) - RD approach in R

### Python box files

- [`python/boxes/box01_rd_approach_in_python.py`](python/boxes/box01_rd_approach_in_python.py) - RD approach in Python
